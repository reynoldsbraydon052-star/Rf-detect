...
# We want to replace askTacticalCopilot completely.
# Find start of askTacticalCopilot
start_idx = content.find("suspend fun askTacticalCopilot(")
if start_idx != -1:
    end_idx = content.find("    private fun parseGeminiThreatResponse", start_idx)
    if end_idx != -1:
        new_method = """suspend fun askTacticalCopilot(
        query: String,
